...
ALTER TABLE "comment" ADD CONSTRAINT "comment_photo_id_photo_id_fkey" FOREIGN KEY ("photo_id") REFERENCES "photo"("id");--> statement-breakpoint
ALTER TABLE "like" ADD CONSTRAINT "like_user_id_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user"("id");--> statement-breakpoint
ALTER TABLE "like" ADD CONSTRAINT "like_photo_id_photo_id_fkey" FOREIGN KEY ("photo_id") REFERENCES "photo"("id");--> statement-breakpoint
ALTER TABLE "photo" ADD CONSTRAINT "photo_user_id_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user"("id");